...
let quotes_array = [
    "Brace Yourself as your going to decode the universe itself.",
    ...
    "The universe is unquestionably huge. ... The observable universe is still huge, but it has limits. That's because we know the universe isn't infinitely old — we know the Big Bang occurred some 13.8 billion years ago. ",
...
function finishGame() {
    ...
    // callling the Save_To_Database() functions
    Save_To_Database();
